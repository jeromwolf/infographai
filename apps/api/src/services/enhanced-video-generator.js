...
exports.EnhancedVideoGenerator = void 0;
exports.startEnhancedVideoGeneration = startEnhancedVideoGeneration;
...
const scenario_templates_1 = require("../templates/scenario-templates");
...
class EnhancedVideoGenerator {
    ...
    async generate() {
        try {
            ...
            const evaluation = (0, scenario_templates_1.evaluateScenarioQuality)(scenario);
            ...
            if (evaluation.score < 70) {
                ...
                const enhanced = (0, scenario_templates_1.enhanceScenario)(scenario, 'conceptExplanation');
    ...
    async generateEnhancedScenario() {
        if (this.scenarioId) {
    ...
    async generateEnhancedSubtitles(scenes) {
        let currentTime = 0;
    ...
    async prepareVisualAssets(scenes) {
    ...
    async createCodeImage(code, sceneId) {
    ...
    async renderEnhancedFrames(scenes) {
        // 향상된 프레임 렌더링
    ...
    generateFrameHtml(scene, progress) {
    ...
    async compileEnhancedVideo(audioPath) {
    ...
    async updateStatus(status, progress, message) {
        await database_1.prisma.video.update({
            where: { id: this.videoId },
            data: {
                status,
...
exports.EnhancedVideoGenerator = EnhancedVideoGenerator;
// Export enhanced generator
async function startEnhancedVideoGeneration(videoId, projectId, scenarioId) {
