...
exports.AIScenarioGenerator = void 0;
...
- Data points where applicable`;
    ...
    generateTemplateScenario(topic, sceneCount) {
        ...
        // Core content scenes
        const contentTypes = ['concept', 'process', 'benefits', 'example'];
...
exports.AIScenarioGenerator = AIScenarioGenerator;
