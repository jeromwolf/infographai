    ...
    return (<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <link_1.default href="/login" className="text-gray-700 hover:text-gray-900">
                로그인
              </link_1.default>
              <link_1.default href="/register" className="btn-primary">
                시작하기
              </link_1.default>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-4">
              <link_1.default href="/register" className="btn-primary inline-flex items-center px-6 py-3 text-lg">
                무료로 시작하기
                <lucide_react_1.ArrowRight className="ml-2 h-5 w-5"/>
              </link_1.default>
              <link_1.default href="/demo" className="btn-secondary inline-flex items-center px-6 py-3 text-lg">
                데모 보기
              </link_1.default>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="bg-primary-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <lucide_react_1.Sparkles className="h-8 w-8 text-primary-600"/>
              </div>
            ...
            <div className="text-center">
              <div className="bg-primary-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <lucide_react_1.Video className="h-8 w-8 text-primary-600"/>
              </div>
            ...
            <div className="text-center">
              <div className="bg-primary-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <lucide_react_1.Globe className="h-8 w-8 text-primary-600"/>
              </div>
            ...
            <div className="text-center">
              <div className="bg-primary-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <lucide_react_1.Zap className="h-8 w-8 text-primary-600"/>
              </div>
      ...
      <section className="py-20 bg-primary-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <link_1.default href="/register" className="bg-white text-primary-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg inline-flex items-center">
            무료 계정 만들기
            <lucide_react_1.ArrowRight className="ml-2 h-5 w-5"/>
          </link_1.default>
        </div>
