...
exports.default = RadialNetwork;
const react_1 = __importStar(require("react"));
const d3 = __importStar(require("d3"));
function RadialNetwork({ centerLabel, nodes, width = 1200, height = 800, innerRadius = 100, outerRadius = 350 }) {
    ...
    return (<div className="relative">
      ...
      {hoveredNode && (<div className="absolute bottom-4 right-4 bg-black bg-opacity-90 text-white p-3 rounded-lg">
