...
exports.default = HandDrawnDiagram;
const react_1 = __importStar(require("react"));
function HandDrawnDiagram({ width = 1200, height = 700, theme = 'dark', animationSpeed = 1 }) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        function drawArrow(ctx, x1, y1, x2, y2, label, dashed = false) {
            ctx.strokeStyle = theme === 'dark' ? '#4ade80' : '#059669';
            if (dashed) {
                ctx.setLineDash([8, 8]);
            }
        ...
        function drawPerson(ctx, x, y, question) {
    ...
    return (<div className="relative">
      <canvas ref={canvasRef} className="rounded-lg shadow-2xl" style={{
      ...
      <div className="absolute bottom-4 left-4 flex gap-2">
        ...
        <button onClick={() => setIsPlaying(!isPlaying)} className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 font-bold">
