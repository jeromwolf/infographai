...
exports.TechTermDictionary = void 0;
class TechTermDictionary {
     ...
     * 용어 번역 결정
     */
    static translate(term, forceKorean = false) {
     ...
     * 문장에서 기술 용어 자동 처리
     */
    static processTermsInText(text) {
        let processed = text;
...
exports.TechTermDictionary = TechTermDictionary;
