...
exports.InteractiveVideoGenerator = exports.KoreanColorPicker = exports.CodeInspector = exports.AlgorithmClock = exports.Algorithm3DVisualizer = void 0;
const canvas_1 = require("canvas");
const events_1 = require("events");
// 1. 3D SVG 시각화 도구 (알고리즘 복잡도 시각화)
class Algorithm3DVisualizer extends events_1.EventEmitter {
    canvas;
    speed = 1;
    distance = 100;
    depth = 50;
     ...
     */
    async generateComplexityGraph(algorithm, inputSize) {
    ...
    drawComplexityCurve(ctx, algorithm, inputSize, frame, project3D) {
        // 복잡도별 곡선 렌더링 로직
    }
    createAnimatedSVG(frames) {
        // SVG 애니메이션 생성
        return `<svg><!-- animated frames --></svg>`;
    }
}
exports.Algorithm3DVisualizer = Algorithm3DVisualizer;
...
class AlgorithmClock {
     ...
     * 알고리즘 실행 시간 시각화
     */
    generateClockSVG(elapsed, operations) {
...
exports.AlgorithmClock = AlgorithmClock;
...
class CodeInspector {
     ...
     * 실시간 편집 with 한글 주석
     */
    editWithHighlight(lineNumber, newCode, highlight) {
...
exports.CodeInspector = CodeInspector;
// 4. OKLCH 컬러 피커 (한국 전통색 포함)
class KoreanColorPicker {
    koreanPalette = {
...
exports.KoreanColorPicker = KoreanColorPicker;
// 5. 통합 인터랙티브 비디오 생성기
class InteractiveVideoGenerator {
     ...
     * 인터랙티브 교육 비디오 생성
     */
    async generateInteractiveVideo(topic, code, options = {}) {
        // 1. 코드 분석
        const analysis = this.inspector.inspectCode(code);
        // 2. 3D 시각화 생성
        let visualization = '';
        if (options.enable3D) {
            visualization = await this.visualizer.generateComplexityGraph(topic, [10, 100, 1000, 10000]);
        }
        // 3. 시계 컴포넌트
        let clockSVG = '';
        ...
        // 4. 색상 팔레트
        const palette = this.colorPicker.generatePalette('oklch(60% 0.15 250)', options.colorScheme === 'korean' ? 'korean' : 'triadic');
        // 5. 인터랙티브 요소 생성
...
exports.InteractiveVideoGenerator = InteractiveVideoGenerator;
exports.default = InteractiveVideoGenerator;
